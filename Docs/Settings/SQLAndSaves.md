...
| Поле | Описание |
|-|-|
|**Spell Script File Name:**|Название файла, которое будет создаваться в момент, когда мы генерируем скрипт. В этом файле будет находится SQL код регестрации этого скрипта для базы данных. Этот файл нужен для отправки в репозиторий.|
