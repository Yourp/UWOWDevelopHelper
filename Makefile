...
# Template: app
# Command: F:\Programs\Qt\5.15.1\mingw81_64\bin\qmake.exe -o Makefile UWOWDevelopHelper.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: UWOWDevelopHelper.pro F:/Programs/Qt/5.15.1/mingw81_64/mkspecs/win32-g++/qmake.conf F:/Programs/Qt/5.15.1/mingw81_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile UWOWDevelopHelper.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
